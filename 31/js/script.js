class MenuBurger {
    constructor() {
        this.burger = document.querySelector('.header-top__menu-burger')
        this.burgerClose = 'header-top__menu-burger--close'
        this.menuList = document.querySelector('.header-top__menu-list')
        this.menuListMob = 'header-top__menu-list--mob'
        this.clickBurger()
    }
    clickBurger() {
        this.burger.onclick = () => {
